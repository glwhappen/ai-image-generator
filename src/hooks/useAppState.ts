  ...
  const submitGeneration = useCallback(async (
    ...
    try {
      const requestBody: Record<string, unknown> = {
        ...
        size: apiConfig.openaiSize && apiConfig.openaiSize !== 'auto' ? apiConfig.openaiSize : undefined,
        doubaoSize: apiConfig.doubaoSize && apiConfig.doubaoSize !== 'auto' ? apiConfig.doubaoSize : undefined,
